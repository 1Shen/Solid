! function (e, t) {
        ...
        return new Promise(function (r) {
            function a(e, t) {
                for (var n = 0; n < M.length; n++)
                    if (e += t, e === M.length ? e = 0 : -1 === e && (e = M.length - 1), M[e].offsetWidth || M[e].offsetHeight || M[e].getClientRects().length) return void M[e].focus()
            }
    ...
    return t.queue = function (e) {
            ...
            N = c({}, a)
        }, t.version = "3.3.8", window.sweetAlert = window.swal = t,
        function () {
