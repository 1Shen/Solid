            ...
            <form class="layui-form" method="POST" action="{{ route('login') }}">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input id="username" type="text" class="layui-input layui-form-danger {{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="admin" required autofocus placeholder="请输入用户名">
